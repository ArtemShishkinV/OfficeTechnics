...
public class ReceiveTenderListCommand extends FrontCommand {
    ...
    public void process() throws ServletException, IOException {
        ArrayList<DeviceAccess> deviceAccesses = tenderDAO.findReceivingTenders();

        request.setAttribute("devices", deviceAccesses);

        forward("receiveTenderList");
    }
}
